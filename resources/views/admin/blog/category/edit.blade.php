...
@section('main_content')
 ...
 <div class="sl-mainpanel">
   ...
   @if ($errors->any())
      ...
      @endif
       <form method="post" action="{{route('update.blog.category',$blogcatedit->id)}}">
        @csrf
     ...
     <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $blogcatedit->category_name_bn }}" name="category_name_bn">
