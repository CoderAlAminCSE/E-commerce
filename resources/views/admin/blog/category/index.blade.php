            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Category Name Bang</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('delete.blog.category',$row->id)}}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                  </td>
       ...
       <form method="post" action="{{route('store.blog.category')}}">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name Bangla" name="category_name_bn">
