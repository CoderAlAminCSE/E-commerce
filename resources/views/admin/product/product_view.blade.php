...
@section('main_content')
 ...
 <div class="sl-mainpanel">
  ...
  <a href="{{ route('product.add') }}" class="btn btn-sm btn-warning" style="float: right;">Add New</a>
          </h6>
  ...
  <a href="{{route('product.details',$row->id)}}" class="btn btn-sm btn-warning" title="Details"><i class="fa fa-eye"></i></a>
