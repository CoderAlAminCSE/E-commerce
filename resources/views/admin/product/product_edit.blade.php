...
@section('main_content')
 ...
 <a href="{{ route('product.view')}}" class="btn btn-success btn-sm pull-right"> All Product</a>
       ...
       <form method="post" action="{{route('update.product.withoutphoto',$product->id)}}" enctype="multipart/form-data">    
        @csrf
...
<br><br>
 ...
 <div class="card pd-20 pd-sm-40">
  ...
  <form method="post" action="{{route('update.product.withphoto',$product->id)}}" enctype="multipart/form-data">    
        @csrf
