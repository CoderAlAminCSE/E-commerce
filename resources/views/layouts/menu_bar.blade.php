                            ...
                            <li class="hassubs">
                                ...
                                <ul>
                                    ...
                                    @foreach ($subcategory as $subcat)
                                        <li><a href="{{ url('products/'.$subcat->id) }}">{{$subcat->subcategory_name}}<i class="fas fa-chevron-right"></i></a></li>
                                    @endforeach
                                </ul>
                            </li>
                            @endforeach
        ...
        <div class="col-lg-5 offset-lg-4 fill_height">
            <div class="banner_content">
                ...
                @if($slider->discount_price == NULL)
                    <h2> ${{ $slider->selling_price }} </h2><br>
                 @else
                    <span class="text-danger">${{ $slider->selling_price }}</span><br>
                    <span style="font-size:30px">${{($slider->selling_price-$slider->discount_price) }}</span>
                 @endif
